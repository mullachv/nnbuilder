var app = angular.module('mdtestApp', ['ngMaterial', 'ngAria', 'ngMessages', 'material.svgAssetsCache', 'ngSanitize', 'ngResource']);
app.controller('mdDataCtrl', ['$scope', '$mdDialog', function ($scope, $mdDialog) {
        $scope.specifyDataset = function ($event) {
            ...
            function saveDatasetChoice(resp) {
